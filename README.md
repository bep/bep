...
- [gohugoio/hugo](https://github.com/gohugoio/hugo) ([v0.89.1](https://github.com/gohugoio/hugo/releases/tag/v0.89.1), 1 day ago) - The world’s fastest framework for building websites.
- [bep/docuapi](https://github.com/bep/docuapi) ([v2.0.1](https://github.com/bep/docuapi/releases/tag/v2.0.1), 1 day ago) - Beautiful multilingual API documentation theme for Hugo
...
- [bep/s3deploy](https://github.com/bep/s3deploy) ([v2.5.1](https://github.com/bep/s3deploy/releases/tag/v2.5.1), 6 days ago) - A simple tool to deploy static websites to Amazon S3 and CloudFront with Gzip and custom headers support (e.g. &#34;Cache-Control&#34;)
...
- [setphen](https://github.com/setphen) (4 days ago)
