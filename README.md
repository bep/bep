...
- [gohugoio/hugo-mod-jslibs](https://github.com/gohugoio/hugo-mod-jslibs) ([spruce/v0.2.0](https://github.com/gohugoio/hugo-mod-jslibs/releases/tag/spruce%2Fv0.2.0), 4 days ago) - A collection of JS libraries that works great with Hugo.
- [bep/docuapi](https://github.com/bep/docuapi) ([v1.5.0](https://github.com/bep/docuapi/releases/tag/v1.5.0), 1 week ago) - Beautiful multilingual API documentation theme for Hugo
...
- [alpinejs/alpine](https://github.com/alpinejs/alpine) ([v2.8.2](https://github.com/alpinejs/alpine/releases/tag/v2.8.2), 3 weeks ago) - A rugged, minimal framework for composing JavaScript behavior in your markup.
- [gohugoio/hugoDocs](https://github.com/gohugoio/hugoDocs) ([v0.82.0](https://github.com/gohugoio/hugoDocs/releases/tag/v0.82.0), 4 weeks ago) - The source for https://gohugo.io/
- [gohugoio/hugo](https://github.com/gohugoio/hugo) ([v0.82.0](https://github.com/gohugoio/hugo/releases/tag/v0.82.0), 4 weeks ago) - The world’s fastest framework for building websites.
...
- [lupsa](https://github.com/lupsa) (1 day ago)
- [lhenze](https://github.com/lhenze) (3 weeks ago)
