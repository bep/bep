...
- [common/hreflect: Replace the map/RWMutex method cache with sync.Map](https://github.com/gohugoio/hugo/pull/13529) on [gohugoio/hugo](https://github.com/gohugoio/hugo) (today)
