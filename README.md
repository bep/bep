...
### Recent releases
- [bep/execrpc](https://github.com/bep/execrpc) ([v0.1.0](https://github.com/bep/execrpc/releases/tag/v0.1.0), today) - RCP via os/exec with generic types.
...
- [bep/workers](https://github.com/bep/workers) ([v1.1.0](https://github.com/bep/workers/releases/tag/v1.1.0), 5 days ago) - Set up tasks to be executed in parallel.
...
- [dgasparri](https://github.com/dgasparri) (4 days ago)
