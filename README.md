...
- [Use a trie with a rune slice](https://github.com/bep/triebytesmapper/pull/1) on [bep/triebytesmapper](https://github.com/bep/triebytesmapper) (today)
- [Fix regression when loading config  -e is empty or HUGO_ENV or HUGO_ENVIRONMENT is set](https://github.com/gohugoio/hugo/pull/11014) on [gohugoio/hugo](https://github.com/gohugoio/hugo) (today)
- [Fix regression with site.IsServer when not running a server](https://github.com/gohugoio/hugo/pull/11011) on [gohugoio/hugo](https://github.com/gohugoio/hugo) (today)
