...
- [gohugoio/hugo](https://github.com/gohugoio/hugo) ([v0.89.4](https://github.com/gohugoio/hugo/releases/tag/v0.89.4), 4 days ago) - The world’s fastest framework for building websites.
- [bep/docuapi](https://github.com/bep/docuapi) ([v2.0.3](https://github.com/bep/docuapi/releases/tag/v2.0.3), 5 days ago) - Beautiful multilingual API documentation theme for Hugo
- [gohugoio/hugo-mod-jslibs-dist](https://github.com/gohugoio/hugo-mod-jslibs-dist) ([alpinejs/v3.500.100](https://github.com/gohugoio/hugo-mod-jslibs-dist/releases/tag/alpinejs%2Fv3.500.100), 5 days ago) - Thin Hugo Module wrappers around some popular JS libs&#39; distribution source code.
- [GoogleChrome/lighthouse](https://github.com/GoogleChrome/lighthouse) ([v9.0.0](https://github.com/GoogleChrome/lighthouse/releases/tag/v9.0.0), 5 days ago) - Automated auditing, performance metrics, and best practices for the web.
