...
### Recent releases
- [gohugoio/hugoreleaser](https://github.com/gohugoio/hugoreleaser) ([v0.51.0](https://github.com/gohugoio/hugoreleaser/releases/tag/v0.51.0), 1 day ago) - Build, archive and release. Work in progress.
...
- [bep/workers](https://github.com/bep/workers) ([v1.1.0](https://github.com/bep/workers/releases/tag/v1.1.0), 3 weeks ago) - Set up tasks to be executed in parallel.
